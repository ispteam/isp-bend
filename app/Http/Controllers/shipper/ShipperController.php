...
class ShipperController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        try{
             ...
             */
            $companyId = intval($request->input("companyId")) ? $request->input("companyId") : 0;
            ...
            $shipper = Shipper::where("companyId", $companyId)->update([
                "companyNameArabic" => $request->input("companyNameArabic"),
                "companyName" => $request->input("companyName"),
            ]);
            ...
            /**
             * Here we check if the shipper updated or not.
