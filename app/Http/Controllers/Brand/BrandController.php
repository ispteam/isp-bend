...
class BrandController extends Controller
{
    ...
    {
        $this->middleware("isAuthorized")->except(["index", "show", "brandsType"]);
    }
    ...
    public function index()
    {
        try{
            ...
            return response()->json([
                ...
                "messageInArabic" => "لا يمكن جلب البيانات",
                "statusCode" => "404"
            ], 404);
        }
    }

    public function brandsType($type){
        try{
            $brands= Brand::where("field", $type)->get();
            return response()->json([
                "brands" => $brands,
                "statusCode" => 200,
            ], 200);
